...
<div class="row"> 
    ...
    <tbody>
    <tr>
    <td align="center"><input type="text" class="form-control input-lg" name="razao_social" id="razao_social" placeholder="Razão Social" value="<?php echo e($id->usuario); ?>" ></td>
    <td align="center"><div style="width: 2px"></div></td>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\Sistemas AgroBella\GitHub\Laravel\loja-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>